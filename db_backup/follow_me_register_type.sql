...
CREATE TABLE `register_type` (
  `reg_type_id` tinyint(10) NOT NULL,
  `reg_type_name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`reg_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='category of user registeration';
...
INSERT INTO `register_type` VALUES (1,'mail'),(2,'phone');
